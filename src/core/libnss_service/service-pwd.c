...
enum nss_status
_nss_service_getpwuid_r (uid_t uid, struct passwd *result,
...
enum nss_status
_nss_service_getpwnam_r (const char *name, struct passwd *result,
			 char *buffer, size_t buflen, int *errnop)
{
  return _nss_service_status_e (errnop);
}
...
enum nss_status
_nss_service_setpwent (void)
{
  return _nss_service_status ();
}

enum nss_status
_nss_service_getpwent_r (struct passwd *result,
			 char *buffer, size_t buflen, int *errnop)
{
  return _nss_service_status_e (errnop);
}
